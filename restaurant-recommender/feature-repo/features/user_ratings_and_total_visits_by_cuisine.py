...
@batch_feature_view(
    ...
    features=[
        Aggregate(
            name="users_average_rating_by_cuisine_last_5y",
            column="rating",
            column_dtype=Int64,
            function="mean",
        ...
        Aggregate(
            name="users_total_visits_by_cuisine_last_5y",
            column="rating",
            column_dtype=Int64,
            function="count",
            time_window=timedelta(days=365 * 5),
...
@on_demand_feature_view(
    ...
    features=[
        Attribute(
            column="user_ratings_and_total_visits_by_cuisine",
            column_dtype=Array(
                Struct(
                    [
...
def user_ratings_and_total_visits_by_cuisine(
    user_ratings_and_total_visits_by_cuisine_raw,
):
    ...
    for cuisine, rating, visit in zip(cuisines, ratings, visits):
        result.append({"cuisine": cuisine, "average_rating": rating, "total_visits": visit})
