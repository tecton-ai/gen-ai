...
@batch_feature_view(
    ...
    features = [ 
                ...
                Attribute(column='categories', column_dtype = Array(Struct([Field('alias', String),Field('title', String)]))),
                Attribute(column='rating', column_dtype = Float64),
                Attribute(column='coordinates', column_dtype = Struct([Field('latitude', Float64),Field('longitude', Float64)])),
                Attribute(column='transactions', column_dtype = Array(String)),
                Attribute(column='price', column_dtype = String),
                Attribute(column='location', column_dtype = Struct([
                                                                    Field('address1', String),
                                                                    Field('address2', String),
                                                                    Field('address3', String),
                                                                    Field('city', String),
                ...
                Attribute(column='attributes', column_dtype = Struct([
                                                                Field('business_temp_closed', Bool),
                                                                Field('menu_url', String),
                                                                Field('open24_hours', Bool),
                                                                Field('waitlist_reservation', Bool)
                ...
                Attribute(column='operationHours', column_dtype = Struct([
                                                                    Field('regularHoursMergedWithSpecialHoursForCurrentWeek', Array(Struct([
                                                                        Field('dayOfWeekShort', String),
                                                                        Field('regularHoursRaw', Array(Array(Int64))),
                                                                        Field('__typename', String)
